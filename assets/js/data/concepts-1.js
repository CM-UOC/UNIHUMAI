...
export default [
{
  ...
  why: 'Without a stated strategy, prioritization collapses into whoever asked most recently or most loudly. With one, you can say no in a way that survives the meeting, because the no follows from a choice everyone already agreed to. In a B2B data business this matters more than usual: every large customer will ask for something bespoke, and without strategy each request looks individually reasonable.',
  ...
  activities: ['Segment and choose a beachhead', 'Name the problem worth solving first', 'State the winning aspiration and the explicit non-goals', 'Test the strategy against the hardest counter-example', 'Socialize until people can repeat it without the slide'],
  ...
  outcomes: ['Prioritization arguments end faster', 'Fewer bespoke commitments', 'Teams can make local decisions that still add up'],
  example: {
    title: 'A vehicle-data strategy that says no',
    body: 'A hub selling standardized multi-brand vehicle data can serve fleets, insurers, workshops and mobility apps. All four are real. A strategy picks one to win first — say fleet operators, because they buy on measurable operating cost, integrate through existing telematics platforms, and need no consumer-facing consent flow. The vision might be: every commercial fleet running Group vehicles can see the health and use of every vehicle without installing hardware. The explicit non-goals then follow: no consumer-facing app, no insurance risk-scoring product this year, no per-customer schema variations. When an insurer arrives with a large deal that needs driving-behavior data and a new consent flow, the strategy does not forbid the conversation — it makes the cost of saying yes visible and the decision a leadership one rather than a PM one.'
  },
  mistakes: [
    ...
    { mistake: 'Omitting non-goals to keep everyone comfortable.', instead: 'The non-goals are the part that holds it up. Without them the strategy cannot refuse anything.' },
    { mistake: 'Treating strategy as a one-off document.', instead: 'Attach review triggers: what evidence would change this? Strategy without a way to prove it wrong is a wish.' }
  ],
  tools: [
...

{
  ...
  mistakes: [
    ...
    { mistake: 'Omitting the cost of doing nothing.', instead: 'Without it you cannot prioritize this against anything else.' }
  ],
  tools: [
    ...
    { name: 'Problem framing canvas', note: 'Who, situation, current behavior, cost, evidence, assumption, success signal.' },
...

{
  ...
  oneLine: 'A specific promise: for this customer, this benefit or this problem removed, better than what they use today.',
  ...
  check: {
    q: 'A proposition says: "Standardized, multi-brand vehicle data, one contract, one API." What is its main weakness?',
    options: [
  ...
  roleLink: { reqs: ['r4', 'r5'], text: 'You are the day-to-day interface with Sales. The value proposition is the artifact that interface runs on — when it is weak, Sales fills the gap by inventing promises, and those come back to you as requirements.' },
...

{
  ...
  oneLine: 'Running a product on purpose through every stage, from first idea to retirement, asking a different question at each one.',
  ...
  youLink: { evidence: ['e-lifecycle', 'e-rolebeforethreshold'], text: 'End-to-end lifecycle work including range gap analysis, SKU rationalization and end-of-life recommendations is directly on your CV, and "role before threshold" is your own stated rule for the hardest lifecycle decision there is.' },
  depends: ['strategy'],
...

{
  ...
  oneLine: 'Lowering the risk of building the wrong thing, by learning before you commit.',
  ...
  when: 'Continuously, weighted toward the front of a product\'s life and toward any moment of large commitment.',
  people: [
  ...
  mistakes: [
    ...
    { mistake: 'Asking customers what they want.', instead: 'Ask what they did, when, and what it cost them. Behavior is evidence; preference is a forecast.' },
  ...
  check: {
    ...
    answer: 2,
    why: 'Rank by consequence, then by cost. Low cost is a tie-breaker, not the criterion — and in regulated data products the killer assumption is often the permission one.'
  },
...

{
  ...
  title: 'User research',
  oneLine: 'Learning about the people who use, buy and support the product, in a way that is careful enough to trust.',
  ...
  people: [
    ...
    { who: 'Engineers', does: 'Observe. One session watched beats ten summarized.' }
  ],
  ...
  activities: ['Recruit the right people, not the willing ones', 'Interview about past behavior, not future intent', 'Observe real work where possible', 'Synthesise into patterns with counts', 'Distinguish finding from interpretation'],
