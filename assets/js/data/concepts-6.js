/* The organisation lesson — folded in from the old standalone map */
export default [
{
  id: 'orgmap', module: 'm6', order: 21, minutes: 12,
  title: 'Where product sits, and who decides what',
  oneLine: 'Almost nothing reports to you, so the first thing to establish is who is allowed to say yes.',
  definition: 'Product management sits at the centre of a set of functions it does not control: engineering and data, design, sales, marketing, partnerships, customer success, operations, legal, privacy, security, brand, finance and portfolio leadership. Each optimises for something real and different. Decision rights describe which of them is allowed to decide what — and in most organisations that is understood informally, inconsistently, and differently by each function.',
  why: 'A product manager has responsibility without authority. Every input you need belongs to someone else, and every output you produce lands on someone else. Where decision rights are unclear, each decision costs days of circulation and eventually gets made by whoever is most confident rather than whoever is accountable.',
  when: 'From your first week. Again whenever the organisation, the stakeholders, or the product\'s stage changes. Most urgently in a newly formed team, where nobody has written it down.',
  people: [
    ...
    { who: 'Portfolio leadership', does: 'Sets the goals, allocates investment, and arbitrates above your decision right.' },
    { who: 'Partners', does: 'External, uncontrolled, with their own roadmap and escalation power your direct customers lack.' }
  ],
  inputs: ['The organisation chart, and the real one underneath it', 'What each function is measured on', 'The history of past decisions and conflicts', 'Any existing governance or gate process'],
  ...
  outcomes: ['Decisions made once', 'Blocking concerns raised early, when they are cheap', 'Weeks of circulation time recovered'],
  decisionRights: [
    ...
    { d:'Accepting a residual risk',         pm:'Depends',        o:'Named owner accepts',          n:'Financial and legal risk acceptance is not within a PM\'s remit.' },
  ...
  tools: [
    ...
    { name: 'Decision-rights document', note: 'Your understanding, circulated for correction. The highest-leverage artefact in a new organisation.' },
  ...
  roleLink: { reqs: ['i1', 'i2', 'r12'], text: 'The GIS:Hub is a joint venture between two parent organisations with different operating tempos and, almost certainly, different governance. The ad asks for pioneers with an ownership mindset. In a hub being built from the ground up, the highest-value early act is usually clarifying who decides — not producing a roadmap.' },
