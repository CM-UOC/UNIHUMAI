...
export const CATEGORIES = [
  ...
  { id:'prioritization', label:'Prioritization',            blurb:'Method, and what you do when the method produces an unwelcome answer.' },
  ...
  { id:'behavioral',    label:'Behavioral',               blurb:'Ambiguity, learning velocity and working style.' },
...
const LESSON_MAP = {
  ...
  'q-strategy-say-no':['negotiation','prioritization'], 'q-strategy-portfolio':['strategy','roadmap'],
  ...
  'q-exec-slip':['risk'], 'q-prior-framework':['prioritization'],
