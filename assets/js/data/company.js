...
export const COMPANY_FACTS = [
  ...
  { src:'company', text:'Static and dynamic vehicle data is consolidated across six Group brands — Volkswagen Passenger Cars, Volkswagen Commercial Vehicles, Audi, Škoda, SEAT and Cupra — and provided in a standardized format.' },
  ...
  { src:'verify', text:'“DUP (Data Usage Process)” is named in the job ad as the product lifecycle framework. Its phases, artifacts, exit criteria and approvers are not publicly documented. Ask about them — do not assume them.' },
...
export const PRODUCT_INFERENCES = [
  { title:'“One contract per use case” makes the use case a product artifact',
  ...
  { title:'Standardization across six brands is the hard part, and it is a definition problem',
    body:'“Standardized format” across six brands and many model years is work, not a property. Signal availability, transmission frequency and field semantics vary. Much of the product manager\'s effort will go into deciding what a field means when the underlying reality differs by brand — and into what the API returns when it does not exist for a given vehicle.' },
  { title:'A partner-led motion makes your interface essential to other businesses',
...
export const ASK_THEM = [
  ...
  { q:'How much of the go-to-market runs through partners versus direct sales, and how does that change what the product team optimizes for?', why:'Shows you have read the public partnership material and understood its product consequences.' },
  ...
  { q:'How do the two parent organizations divide governance — who approves what?', why:'Directly relevant to the structural ambiguity of a joint hub, and it shows you have thought about how the venture is put together.' }
];
