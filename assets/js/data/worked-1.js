/* Worked examples — requirements r1 to r7.
   kind: 'say'      words to speak, verbatim
         'artefact' a document, table or checklist you could actually bring
...
r3: [
  ...
  { kind:'artefact', label:'The five-family requirement sheet for one endpoint',
...
r4: [
  ...
  { kind:'say', label:'The failure mode, named from the inside',
    body:'“The failure I know best is Sales promising a capability that does not exist. It is almost never dishonesty — it is a rep under quota pressure, in a room, filling a silence, with an imperfect picture of what the product does. So I do not treat it as a behaviour problem. I prevent it by enabling on limits as well as on capability: the enablement pack says explicitly what the product does not do, and the customer-facing roadmap view carries confidence language rather than dates. And when a request does come in, I ask what the customer is trying to achieve before I cost anything, because half the time the promise was a guess at a solution and the real need has a cheaper answer we already have.”' }
],

r5: [
  { kind:'artefact', label:'The decision rule, written down before you need it',
