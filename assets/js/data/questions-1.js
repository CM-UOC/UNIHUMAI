...
export default [
{
  ...
  example:'I am an Assistant Product Manager at Saint-Gobain IDAPLAC in Barcelona, where I run defined workstreams across the end-to-end lifecycle of B2B product lines in European markets — definition, portfolio planning, launch, and post-launch optimisation across Spain and Portugal. I came into product from the commercial side: I spent three years leading a SaaS sales team, which is where I learned what Sales actually needs from a product manager and how badly it goes when that loop is informal. The piece of work I am proudest of is an internal pricing application — I framed the problem, specified it and built it, and it is in ongoing internal use, with the controls built into the task rather than reported afterwards. What draws me to this role is that it sits exactly on the seam I know best: a data product with real governance constraints, sold through a direct Sales interface, in a hub that is being built rather than inherited.',
  alternatives:[
...
},
{
  ...
  assess:'Product judgement end to end: how you framed a problem, what you decided and why, how you handled constraints, and — critically — whether you overclaim its results.',
  structure:{
  ...
  weak:['Claiming a percentage improvement you cannot evidence.','Describing the tool\'s features rather than the decisions.','Omitting the accessibility decision — it is the one that shows product maturity.'],
...
},
{
  ...
  q:'Your CV says you "drive defined workstreams" and provide "inputs for prioritisation". What do you actually decide?',
  assess:'Whether you inflate your scope. This is the seam in your profile and a good interviewer will find it. The winning answer is precise, unapologetic, and ends by naming what you are ready to own.',
  ...
  weak:['Claiming you own the roadmap when your materials say otherwise — it is checkable and it costs you everything.','Apologising for the scope.','Vagueness: "I am involved in all of it."'],
...
},
{
  ...
  assess:'Preparation and judgement. They will notice both what you know and whether you distinguish what you have read from what you are guessing.',
  ...
  example:'From public material: Volkswagen Group Info Services is the central vehicle-data interface for the Group, founded in 2019 and operating in its current form since 2021, and it runs a Data Hub offering standardised static and dynamic data across six brands — Volkswagen Passenger Cars, Volkswagen Commercial Vehicles, Audi, Škoda, SEAT and Cupra — under a model described as one face, one contract per use case, one system, with API access to over 100 data points per vehicle. The published solution areas are repair and maintenance, retail and importer, insurance, maps and life services, and fleet management, and there have been public partnership announcements with telematics and fleet providers. What I infer as a product manager: one contract per use case means the use-case definition is a product artefact, not a sales one — the same field used for a different purpose is a different product with different permissions. And the partnership route means the API is load-bearing for someone else\'s business, which makes versioning and deprecation policy a commercial matter. What I would ask is how the DUP phases are gated and who the decision-maker is at each one, because that is not public and it is the shape of the job.',
  alternatives:['Verify the current partner list and brand list before the interview — announcements change.'],
  followups:['Which use case would you prioritise?','What do you think our biggest product risk is?'],
...
},
{
  ...
  assess:'Whether you bluff. DUP is internal; you cannot know it. The right answer says so, then demonstrates the phase logic you do run and maps it onto their named phases.',
